...
struct StackCardView: View {
    ...
    var body: some View {
        ...
        GeometryReader{ proxy in
            ...
            .offset(x: offset)
            .rotationEffect(.init(degrees: getRotation(forWidth: size.width, angle: 8)))
    ...
    func getRotation(forWidth width: CGFloat, angle: Double) -> Double{
        let rotation = (offset / (width - 50) * angle)
        return rotation
    }
